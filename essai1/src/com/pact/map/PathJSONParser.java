...
public class PathJSONParser {
	...
	public ArrayList<LatLng> getInfo2(
			JSONObject jObject) {
			...
			for (int i = 0; i < jRoutes.length(); i++) {
				...
				for (int j = 0; j < jLegs.length(); j++) {
					...
					for (int k = 0; k < jSteps.length(); k++) {
						...
						point.add(new LatLng((Double) ((JSONObject) ((JSONObject) jSteps
										.get(k)).get("end_location")).get("lat"), (Double) ((JSONObject) ((JSONObject) jSteps
